...
if __name__ == "__main__":
    ...
    elif args.command == 'seed-av-neighborhoods':
        import seed_av_neighborhoods as sav
        sav.seed_av_neighborhoods()
    else:
        parser.print_help()
